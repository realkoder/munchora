  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-violet-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Our advanced AI understands your preferences and dietary
                  requirements to generate unique recipes from cuisines around
                  the world.
                </p>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  organize your grocery shopping with intelligent
                  categorization.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
        ...
        <div className="bg-white rounded-2xl p-12 shadow-lg mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                We believe cooking is an art form that brings people together
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Using cutting-edge AI to revolutionize how we approach cooking
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Making cooking accessible to everyone, regardless of skill level
              </p>
            </div>
          </div>
        </div>
        ...
        {/* CTA Section */}
        <div className="text-center bg-gradient-to-r from-sky-500 to-violet-500 rounded-2xl p-12 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <NavLink to="/sign-in">
              <Button
                size="lg"
                className="bg-white text-sky-600 hover:bg-gray-100 text-lg px-8 py-3"
              >
                Get Started Free
              </Button>
            </NavLink>
