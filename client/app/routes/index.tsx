          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-2xl">
                Let AI craft personalized recipes from cuisines around the
                world. Organize your cooking with smart grocery lists and share
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative overflow-hidden rounded-xl shadow-lg">
                  <img
                    src="/asian-stir-fry.png?height=150&width=200&text=Asian+Stir+Fry"
                    alt="Colorful Asian stir fry"
                    className="w-full h-32 object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent"></div>
                  <div className="absolute bottom-8 left-2 text-white text-xs">
                    <p className="font-medium">Asian Fusion</p>
                  </div>
                </div>

                <div className="relative overflow-hidden rounded-xl shadow-lg">
                  <img
                    src="/salad-bowl.png?height=150&width=200&text=Fresh+Salad+Bowl"
                    alt="Fresh colorful salad bowl"
                    className="w-full h-32 object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent"></div>
                  <div className="absolute bottom-2 left-2 text-white text-xs">
                    <p className="font-medium">Healthy Bowl</p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow overflow-hidden">
              <div className="aspect-video overflow-hidden">
                <img
                  src="/ai-recipe-gen.png?height=200&width=400&text=AI+Recipe+Generation"
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow overflow-hidden">
              <div className="aspect-video overflow-hidden">
                <img
                  src="/grocery-shopping.png?height=200&width=400&text=Smart+Grocery+Shopping"
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow overflow-hidden">
              ...
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600">
                  Share your favorite recipes and collaborate on grocery lists
                  with family and friends for better meal planning.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              From inspiration to delicious meals in three simple steps
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Tell our AI what you want to cook - cuisine type, ingredients, dietary preferences, or cooking time.",
                image:
                  "/craving-pancake.png?height=200&width=300&text=AI+Chat+Interface",
              },
              {
                step: "2",
              ...
              },
              {
                ...
                title: "Cook & Share",
                description:
                  "Follow the recipe, add it to your grocery list, and share your culinary creation with friends and family.",
                image:
                  "/placeholder.svg?height=200&width=300&text=Cooking+Process",
              },
            ].map((step, index) => (
              <div key={index} className="text-center">
                <div className="relative mb-8">
                  ...
                  />
                  <div className="absolute -top-4 -left-4 bg-sky-500 text-white w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold shadow-lg">
                    {step.step}
                  </div>
                </div>
