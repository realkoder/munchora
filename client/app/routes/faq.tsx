...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Faq page" },
    { name: "FAQ", content: "Welcome to Munchora!" },
  ];
}
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Find answers to common questions about Munchora. Can't find what
            ...
            <CardContent className="p-8">
              ...
              <Accordion type="single" collapsible className="space-y-2">
                {category.questions.map((faq, questionIndex) => (
                  ...
                  >
                    <AccordionTrigger className="text-left font-medium text-gray-900 hover:text-sky-600 py-4">
                      {faq.question}
                    </AccordionTrigger>
      ...
      <Card className="mt-12 shadow-lg border-0 bg-gradient-to-r from-sky-500 to-violet-500 text-white">
        <CardContent className="p-8 text-center">
          <h2 className="text-2xl font-bold mb-4">Still Have Questions?</h2>
          <p className="text-sky-100 mb-6 text-lg">
            Our support team is here to help you make the most of Munchora
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-white text-sky-600 hover:bg-sky-50 flex items-center space-x-2"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white text-sky-600 hover:bg-white hover:text-sky-600 flex items-center space-x-2"
            >
      ...
      <div className="mt-12 grid md:grid-cols-3 gap-6">
        <Card className="text-center hover:shadow-lg transition-shadow">
          <CardContent className="p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Learn the basics of using Munchora
            </p>
            <NavLink to="/about">
        ...
        <Card className="text-center hover:shadow-lg transition-shadow">
          <CardContent className="p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Connect with other Munchora users
            </p>
            <Button variant="outline" size="sm">
              Join Community
            </Button>
